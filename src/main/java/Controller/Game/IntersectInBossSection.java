...
public class IntersectInBossSection extends IntersectInGame {

    BossFightSectionScreen levelScreen;
    public VilgaxIntersection vilgaxIntersection;
    ...
    private void init() {
        ...
        vilgaxIntersection = new VilgaxIntersection(gameGodFather) {
            ...
            public void vilgaxIntersectWithObjects() {
                super.vilgaxIntersectWithObjects();
            }

            @Override
            public void bombIntersectVilgax() {
                super.bombIntersectVilgax();
            }
            ...
            public void marioWeaponIntersectsVilgax() {
                super.marioWeaponIntersectsVilgax();
            }
