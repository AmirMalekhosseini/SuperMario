...
public class LevelOneSectionOneScreen extends LevelScreens {
    ...
    public LevelOneSectionOneScreen(GameData gameData) {
        init(gameData);
    }
...
//        Add Mario:
        ...
        checkPointSceneTwo = new CheckPoint(2580, 470);
        ...
        itemsInThisSection.add(checkPointSceneTwo);
