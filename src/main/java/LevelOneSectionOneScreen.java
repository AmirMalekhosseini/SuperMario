...
public class LevelOneSectionOneScreen extends JLayeredPane {
    ...
    protected ArrayList<Mario> activeMario;
    ...
    UserHeart userHeartImage;
    JLabel userHeartValueLabel;
    JLabel userScoreLabel;
    JLabel thisSectionTimeLabel;
    JLabel thisGameCoin;
    CoinForStore thisGameCoinImage;
    LevelOneSectionOneTime thisSectionTime;

    protected int XUserHeartImage = 1520;
    protected int XUserHeartValueLabel = 1510;
    protected int XUserScoreLabel = 1345;
    protected int XThisSectionTimeLabel = 1180;
    protected int XThisGameCoin = 1080;
    protected int XThisGameCoinImage = 1110;
    ...
    LevelOneSectionOneScreen(GameData gameData) {
        ...
        userHeartValueLabel = new JLabel(String.valueOf(gameData.userHeartValue));
        userHeartValueLabel.setBounds(XUserHeartValueLabel, 30, 20, 20);
        userHeartValueLabel.setFont(font1);

        userScoreLabel = new JLabel("Score: " + String.valueOf(gameData.thisGameScore));
