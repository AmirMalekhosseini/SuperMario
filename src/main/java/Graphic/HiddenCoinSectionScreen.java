...
public class HiddenCoinSectionScreen extends JLayeredPane {
    ...
    BlockInAir blockInAir2_11;
    BlockInAir blockInAir2_12;
    ...
    BlockInAir blockInAir3_9;
    BlockInAir blockInAir3_10;
...
//        Add Mario:
        ...
        blockInAir1_1 = new SimpleBlockInAir(400, 350);
        blockInAir1_2 = new SimpleBlockInAir(470, 350);
        blockInAir1_3 = new SimpleBlockInAir(540, 350);
        blockInAir1_4 = new SimpleBlockInAir(610, 350);
        blockInAir1_5 = new SimpleBlockInAir(680, 350);
        blockInAir1_6 = new SimpleBlockInAir(750, 350);
        blockInAir1_7 = new SimpleBlockInAir(820, 350);
        blockInAir1_8 = new SimpleBlockInAir(890, 350);
        blockInAir1_9 = new SimpleBlockInAir(960, 350);
        blockInAir1_10 = new SimpleBlockInAir(1030, 350);
        blockInAir1_11 = new SimpleBlockInAir(1100, 350);
        blockInAir1_12 = new SimpleBlockInAir(1170, 350);
        blockInAir1_13 = new SimpleBlockInAir(1240, 350);
        blockInAir1_14 = new SimpleBlockInAir(1310, 350);

        cannon_2 = new Cannon(1260, 470);
        blockInAir2_1 = new SimpleBlockInAir(540, 550);
        blockInAir2_2 = new SimpleBlockInAir(610, 550);
        blockInAir2_3 = new SimpleBlockInAir(680, 550);
        blockInAir2_4 = new SimpleBlockInAir(750, 550);
        blockInAir2_5 = new SimpleBlockInAir(820, 550);
        blockInAir2_6 = new SimpleBlockInAir(890, 550);
        blockInAir2_7 = new SimpleBlockInAir(960, 550);
        blockInAir2_8 = new SimpleBlockInAir(1030, 550);
        blockInAir2_9 = new SimpleBlockInAir(1100, 550);
        blockInAir2_10 = new SimpleBlockInAir(1170, 550);
        blockInAir2_11 = new SimpleBlockInAir(1240, 550);
        blockInAir2_12 = new SimpleBlockInAir(1310, 550);

        cannon_3 = new Cannon(1260, 670);
        blockInAir3_1 = new SimpleBlockInAir(680, 750);
        blockInAir3_2 = new SimpleBlockInAir(750, 750);
        blockInAir3_3 = new SimpleBlockInAir(820, 750);
        blockInAir3_4 = new SimpleBlockInAir(890, 750);
        blockInAir3_5 = new SimpleBlockInAir(960, 750);
        blockInAir3_6 = new SimpleBlockInAir(1030, 750);
        blockInAir3_7 = new SimpleBlockInAir(1100, 750);
        blockInAir3_8 = new SimpleBlockInAir(1170, 750);
        blockInAir3_9 = new SimpleBlockInAir(1240, 750);
        blockInAir3_10 = new SimpleBlockInAir(1310, 750);
        ...
        this.add(blockInAir2_11, Integer.valueOf(1));
        this.add(blockInAir2_12, Integer.valueOf(1));
        ...
        this.add(blockInAir3_9, Integer.valueOf(1));
        this.add(blockInAir3_10, Integer.valueOf(1));
        ...
        objectsInThisSection.add(blockInAir2_11);
        objectsInThisSection.add(blockInAir2_12);
        ...
        objectsInThisSection.add(blockInAir3_9);
        objectsInThisSection.add(blockInAir3_10);
