...
public class LevelTwoSectionTwoModel {
    ...
    public LevelTwoSectionTwoModel(LevelTwoSectionTwoScreen levelTwoSectionTwoScreen, IntersectInLevelTwoSectionTwo intersect, MarioMoverModel marioMoverModel) {
    ...
    public void moveEnemy() {
        ...
        for (int i = 0; i < levelTwoSectionTwoScreen.getEnemiesInThisSection().size(); i++) {
            ...
            if (levelTwoSectionTwoScreen.getEnemiesInThisSection().get(i) instanceof Spiny) {
                int marioX = levelTwoSectionTwoScreen.activeMario.getX();
                int marioY = levelTwoSectionTwoScreen.activeMario.getY();
                int marioHeight = levelTwoSectionTwoScreen.activeMario.getHeight();
            ...
            levelTwoSectionTwoScreen.getEnemiesInThisSection().get(i).changeBackground();
        ...
        for (int i = 0; i < levelTwoSectionTwoScreen.getBombsInThisSection().size(); i++) {
            intersect.intersection.bombIntersection(levelTwoSectionTwoScreen.getBombsInThisSection().get(i));
        }
    ...
    public void moveShot() {
        ...
        ArrayList<MarioWeapon> weaponsInThisSection = levelTwoSectionTwoScreen.getWeaponsInThisSection();
    ...
    public void setLocationAfterLoose() {
        ...
        levelTwoSectionTwoScreen.activeMario.setX(100);
